...
class Graph3dKit():
    ...
    def __init__(self, compound):
        self.atomElements = compound['atom_elements']
        # bond block (info)
        self.atomBonds = compound['atom_block']
        self.xyzList = compound['xyz_list']
        self.xyzCenterList = compound['xyz_center_list']
        self.atomBonds_1d = compound['atom_bonds_1d']
        # set structure type
    ...
    def view3d(self, subgraphs=None, **kwargs):
        ...
        display_bond_length = kwargs.get('display_bond_length', True)
